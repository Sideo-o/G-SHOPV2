...
<body>
  ...
  <section class="py-5">
    <div class="container">
      <h2 class="mb-4">About G-Shop</h2>
      <p class="lead">G-Shop is a demo GPU marketplace showcasing high-performance graphics cards for gaming, AI, and creative workflows. We curate tested cards from trusted vendors and provide secure shipping and warranty support.</p>

      <div class="row mt-4">
        <div class="col-md-6">
          <div class="feature-box mb-3">
            <h5>Our Mission</h5>
            <p>Deliver top-tier GPUs and provide world-class support for builders and creators.</p>
          </div>
        </div>
        <div class="col-md-6">
          <div class="feature-box mb-3">
            <h5>Verified Stock</h5>
            <p>All products are tested and verified before shipping to ensure quality and authenticity.</p>
          </div>
        </div>
      </div>
        ...
        <div class="modal-body">
          <div class="tab-content">
            <div class="tab-pane active" id="pane-login">
              ...
              <form id="loginForm3">
                <div class="mb-3"><label class="form-label">Email</label><input type="email" class="form-control dark-input" id="loginEmail3"></div>
                <div class="mb-3 position-relative"><label class="form-label">Password</label>
                  <div class="input-group"><input type="password" class="form-control dark-input" id="loginPassword3"><button class="btn btn-outline-secondary btn-eye" type="button" data-target="#loginPassword3"><i class="bi bi-eye"></i></button></div>
                </div>
            ...
            <div class="tab-pane" id="pane-register">
              ...
              <form id="registerForm3">
                ...
                <div class="mb-3 position-relative"><label class="form-label">Password</label><div class="input-group"><input type="password" class="form-control dark-input" id="regPassword3"><button class="btn btn-outline-secondary btn-eye" type="button" data-target="#regPassword3"><i class="bi bi-eye"></i></button></div></div>
                <div class="mb-3 position-relative"><label class="form-label">Re-type Password</label><div class="input-group"><input type="password" class="form-control dark-input" id="regPassword33"><button class="btn btn-outline-secondary btn-eye" type="button" data-target="#regPassword33"><i class="bi bi-eye"></i></button></div></div>
